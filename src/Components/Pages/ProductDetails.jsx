...
const ProductDetails = () => {
 ...
 const handlemycart = () => {
    fetch('https://brand-shop-server-pv8bd4lx4-shamim-rezas-projects.vercel.app/productsCart', {
        method: "POST", 
        headers: {
                ...
                <div className="container px-5 py-24 mx-auto">
                  <div className="lg:w-4/5 mx-auto flex flex-wrap">
                    ...
                    <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                      <h2 className="text-sm title-font  tracking-widest">{singleItem.brand}</h2>
                      <h1 className=" text-3xl title-font font-medium mb-1">{singleItem.name}</h1>
