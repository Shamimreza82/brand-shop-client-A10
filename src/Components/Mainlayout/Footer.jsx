...
const Footer = () => {
    ...
    <div className="col-span-3">
      ...
      <form action="#" className="mb-2">
        <div className="form-append">
          <input className="form-input form-input-sm p-2 rounded-md mb-3 border" type="email" placeholder="Enter your email" />
          <button className="btn-sm bg-[#F08E31] text-white rounded-md" type="submit">Subscribe</button>
        </div>
      </form>
  ...
  <div className="flex flex-col items-start justify-between pt-10 mt-10 border-t border-gray-100 md:flex-row md:items-center">
    <p className="mb-6 text-sm text-left  md:mb-0">© Copyright 2020 Skcript. All Rights Reserved.</p>
    <div className="flex items-start justify-start space-x-6 md:items-center md:justify-center">
      <a href="#" className="text-sm  transition hover:text-primary">Terms</a>
      <a href="#" className="text-sm  transition hover:text-primary">Privacy</a>
    </div>
  </div>
</footer>
      </div>
